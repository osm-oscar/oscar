define(["jquery"], menu = {
    displayCategories: function () {
        ...
        if (c.is(":empty")) {
            ...
            for (category in menu.categories) {
                d += "<a style='border: none' class='list-group-item' onclick=\"menu.displaySubCategories('"
                    + category +
                    "')\"><i class='fa fa-" + menu.categories[category].img + "'></i>&nbsp; " + menu.categories[category].desc + "</a>";
            }
            d += "</div>";
            c.append(d);
        }
    ...
    displaySubCategories: function (category) {
        ...
        for (subcategory in menu.categories[category]["subcategories"]) {
            ...
            d += "<a style='border: none' class='list-group-item' onclick=\"menu.appendToSearchString('@"
                + key + ":" + menu.categories[category]["subcategories"][subcategory].value + "')\">"
                + menu.categories[category]["subcategories"][subcategory].desc + "</a>";
        }
        d += "</div>";
        c.append(d);
    },
