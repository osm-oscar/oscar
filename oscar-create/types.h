...
struct OsmGeneralizedTrieCreatorConfig: public sserialize::GeneralizedTrie::GeneralizedTrieCreatorConfig {
	
};

// typedef sserialize::spatial::GeoWay GeoWay;
// typedef sserialize::spatial::GeoPolygon GeoPolygon;
// typedef sserialize::spatial::GeoMultiPolygon GeoMultiPolygon;
...
public:
	...
	OsmGeneralizedTrieCreatorConfig toTrieConfig(const oscar_create::Options::TextSearchConfig & cfg);
...
inline std::ostream& operator<<(std::ostream& out, const oscar_create::BoundariesInfo & binfo) {
