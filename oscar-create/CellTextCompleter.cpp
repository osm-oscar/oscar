...
void MatchDesc::initValueContainer(uint32_t* &dataBegin, const std::pair<uint32_t*, uint32_t*> & SSERIALIZE_CHEAP_ASSERT_PASS(dataWindow), MyNodeStorageHashTable::iterator & begin, const MyNodeStorageHashTable::iterator & end) {
